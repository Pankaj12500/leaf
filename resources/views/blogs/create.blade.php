            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-primary float-right " href="{{ route('blogs.index') }}">Go Back</a>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('blogs.store') }}" novalidate>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="description" id="description" cols="40" rows="5" class="form-control @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
